...
class IMUOutput {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IMUOutput
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IMUOutput
    let len;
    let data = new IMUOutput(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new IMUOutput(null);
